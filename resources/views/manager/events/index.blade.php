                    ...
                    <div class="container px-5 py-8 mx-auto">
                        ...
                        <div class="lg:w-5/6 w-full mx-auto overflow-auto">
                            <div class="flex justify-end gap-6">
                                <button onclick="location.href='{{route('events.past')}}'" class="flex mb-4 text-white bg-green-500 border-0 py-2 px-6 focus:outline-none hover:bg-green-600 rounded">過去のイベント一覧</button>
                                <button onclick="location.href='{{route('events.create')}}'" class="flex mb-4 text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">新規登録</button>
                            </div>
